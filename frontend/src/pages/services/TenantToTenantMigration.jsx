      ...
      <section className="service-hero">
        <div className="container">
          <div className="service-hero-content">
            <h1>Shefware Tenant to Tenant Migration</h1>
            <p className="hero-description">
              Safe and secure tenant-to-tenant migration.
            </p>
            <p className="service-detailed-description">
              Safe and secure tenant-to-tenant migration—transfer mailboxes,
              files, users, and Teams from one Microsoft 365 tenant to another.
              Typical drivers include mergers and acquisitions, divestitures, and
              rebranding.
            </p>
