...
const Services = () => {
  ...
  return (
    <>
      ...
      {/* Services Navigation and Grid Section */}
      <section className="services-navigation-frame">
        {/* Top Navigation Bar */}
        {/* <div className="top-navigation">
          <div className="top-nav-links">
            <a href="#support" className="top-nav-link">Support</a>
            <a href="#about" className="top-nav-link">About Us</a>
            <a href="#contact" className="top-nav-link">Contact Us</a>
          </div>
        </div> */}
        ...
        {/* <div className="main-navigation">
          <div className="nav-container">
            <div className="logo">
              <span className="logo-text">Shefware</span>
            </div>
            <div className="nav-items">
              <a href="#products" className="nav-item">products</a>
              <a href="#services" className="nav-item nav-highlighted">Services</a>
              <a href="#market-place" className="nav-item">market place</a>
              <a href="#why-shefware" className="nav-item">Why Shefware</a>
            </div>
          </div>
        </div> */}
            ...
            <div className="process-accordion">
              ...
              <div className="accordion-item active">
                ...
                <div className="accordion-content">
                  <p>Start the process, monitor progress, and export data seamlessly with our intuitive tracking system.</p>
                </div>
              </div>
            </div>
            ...
            <div className="resource-card resource-card-1">
              ...
              <div className="resource-description-margin">
                <div className="resource-description-container">
                  <p className="resource-description">Know about the latest product announcements and enhancements.</p>
                </div>
              </div>
